...
import org.chhotescientists.activity.UpdateDetailActivity;
import org.chhotescientists.adapter.CustomRecycleUpdateAdapter;
...
public class UpdateFragment extends Fragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myCache = MyCache.getInstance(this.getActivity());
    }
    ...
    private void loadUpdates() {
            ...
            JsonObjectRequest jsonReq = new JsonObjectRequest(Request.Method.GET, getString(R.string.get_updates), null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (response != null) {
                        ...
                        mPreferences.setUpdates(response.toString());
                    }
                }
        ...
        else if(mPreferences.getUpdates()!="") {
            JSONObject updates;
            try {
                Log.i(getTag(),"Fetching from preferences :"+mPreferences.getUpdates());
                updates = new JSONObject(mPreferences.getUpdates());
                parseJsonFeed(updates);
